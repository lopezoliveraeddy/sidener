...
import electorum.sidener.domain.Authority;
import electorum.sidener.domain.User;
import electorum.sidener.repository.UserRepository;
import electorum.sidener.repository.search.UserSearchRepository;
import electorum.sidener.security.AuthoritiesConstants;
import electorum.sidener.service.MailService;
import electorum.sidener.service.UserService;
import electorum.sidener.service.dto.UserDTO;
import electorum.sidener.service.mapper.UserMapper;
import electorum.sidener.web.rest.errors.ExceptionTranslator;
import electorum.sidener.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder("ROLE_USER", "ROLE_ADMIN", "ROLE_ABT", "ROLE_ABR", "ROLE_AI", "ROLE_IS", "ROLE_SD")));
    }
