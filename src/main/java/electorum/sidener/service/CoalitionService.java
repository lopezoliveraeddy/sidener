...
public class CoalitionService {
    ...
    private final Logger log = LoggerFactory.getLogger(CoalitionService.class);
    ...
    public CoalitionService(CoalitionRepository coalitionRepository, CoalitionMapper coalitionMapper, CoalitionSearchRepository coalitionSearchRepository) {
