...
@Service
@Transactional
public class PollingPlaceServiceImpl implements PollingPlaceService{

    private final Logger log = LoggerFactory.getLogger(PollingPlaceServiceImpl.class);
    ...
    public PollingPlaceServiceImpl(PollingPlaceRepository pollingPlaceRepository, PollingPlaceMapper pollingPlaceMapper, PollingPlaceSearchRepository pollingPlaceSearchRepository) {
