...
public class ElectionTypeServiceImpl implements ElectionTypeService{
    ...
    private final Logger log = LoggerFactory.getLogger(ElectionTypeServiceImpl.class);
    ...
    public ElectionTypeServiceImpl(ElectionTypeRepository electionTypeRepository, ElectionTypeMapper electionTypeMapper, ElectionTypeSearchRepository electionTypeSearchRepository) {
