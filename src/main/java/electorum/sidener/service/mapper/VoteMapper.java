 ...
 */
@Mapper(componentModel = "spring", uses = {ElectionMapper.class, PoliticalPartyMapper.class, IndependentCandidateMapper.class, CoalitionMapper.class, PollingPlaceMapper.class, })
