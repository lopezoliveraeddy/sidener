...
public class PollingPlaceResource {
	 ...
	 *
	 * @param pollingPlaceDTO
	 *            the pollingPlaceDTO to create
	 ...
	 *
	 * @param id
	 *            the id of the pollingPlaceDTO to retrieve
	 ...
	 *
	 * @param id
	 *            the id of the pollingPlaceDTO to delete
	 ...
	 *
	 * @param query
	 *            the query of the pollingPlace search
	 * @param pageable
	 *            the pagination information
